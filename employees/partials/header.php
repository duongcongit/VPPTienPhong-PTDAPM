...
<head>
    ...
    <link rel="stylesheet" href="../../employees/assets/css/style.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="../../employees/assets/js/script.js"></script>
</head>
            ...
            <div class="col-md-12 p-0">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container-fluid">
                        ...
                        <a href="#">
                            <img src="../../employees/assets/img/logotp.jpg" alt="" class="logo ms-3" style="width:105px">
                        </a>
                        <a class="navbar-brand me-auto ms-3 h5 pt-3" href="index.php">Trang Nhân Viên</a>
            ...
            <div class="container sidebar sidebar-show">
                ...
                <div class="sidebar-menu">
                    <ul class="">
                        ...
                        <li>
                            <a href="../../view/employees/customerCare.php" class="nav-link link-dark">
                        ...
                        <li>
                            <a href="../../view/employees/reportView.php" class="nav-link link-dark">
