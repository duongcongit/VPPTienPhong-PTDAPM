...
<body>
        ...
        <div class="container-fluid taskbar shadow">
            ...
            <nav class="navbar navbar-expand-lg navbar-light row">
                <div class="container-fluid col-md-12">
                    ...
                    <div class="logo">
                        <a class="navbar-brand" href=""><img src="../assets/images/logo.png" alt="" style="width: 150px;"></a>
                    </div>
    ...
    <div class="container-fluid main p-0">
        <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 row d-flex justify-content-evenly">
                        ...
                        <div class="pb-3 items-card col-sm-5 col-md-3" style="width: 17rem;">
                            <a href="./detail.php">
                                <img src="../assets/images/products/bam_lo.jpg" class="card-img-top" alt="...">
                            </a>

                            <hr class="p-0 m-0 mb-4 m-auto d-none d-md-flex" style="width: 50%;">
                            <div class="d-flex justify-content-center">
                                <a href="./detail.php">
                                <h6 class="card-title">Bấm kim 50LA - 210 tờ</h6>
                                </a>
                            </div>
                            <div class="d-flex justify-content-center">
            ...
            <!-- Banner 2 -->
            <div class="col-md-12 mb-5 banner p-0">
                <img src="../assets/images/office-banner.jpg" alt="">
            ...
            <div class="content ps-5">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 row d-flex justify-content-evenly">
                        <!-- Items -->
                        <div class="pb-3 items-card col-sm-5 col-md-3" style="width: 17rem;">
                            <img src="../assets/images/products/print.png" class="card-img-top" alt="...">
                            <hr class="p-0 m-0 mb-4 m-auto d-none d-md-flex" style="width: 50%;">
                            <div class="d-flex justify-content-center">
