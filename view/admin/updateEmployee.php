...
<div class="col-md-12 manage-products shadow">
    ...
    <div class="col-md-12 d-flex justify-content-center">
        <div class="col-md-11">
            <hr>
            <form method="POST" action="updateEmployeeProcess.php" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="col-md-12 py-2 d-flex justify-content-end">
                    <a type="button" href="employees.php" class="btn btn-secondary px-4">Hủy và quay lại</a>
