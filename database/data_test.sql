...
INSERT INTO `employees` (`employeeID`, `fullname`, `gender`, `address`, `phone`, `email`, `username`, `password`, `status`) VALUES (NULL, 'Nhân Viên', 'Nam', 'Tây Sơn, Hà Nội', '0987654321', 'nhanvien@gmail.com', 'nhanvien', 'nhanvien', '1');
...
INSERT INTO `categories` (`categoryID`, `name`) VALUES ('DUNGCU', 'Dụng cụ văn phòng');
...
INSERT INTO `products` (`productID`, `productName`, `detail`, `stock`, `sold`, `price`, `status`, `categoryID`, `supplierID`) 
VALUES ('SPGA5EX80', 'Giấy A5 Excel 80 Gsm', '', '1000', '260', '28000', '1', 'GIAYINAN', '1');
...
INSERT INTO `product_image` (`imageID`, `imageURL`, `productID`) 
VALUES ('1imageSPGA5EX80', 'https://cdn.fast.vn/tmp/20221026132948-z3830392318118_9c4f34eeadac9a88775d64847af8a9be.jpg', 'SPGA5EX80');
