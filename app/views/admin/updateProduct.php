...
<div class="col-md-12 manage-products shadow">
        ...
        <form action="" method="POST" enctype="multipart/form-data" id ="myForm" class="ms-5">
            ...
            <div class="input-group mb-3">
                ...
                if(isset($product['image1']) && (!isset($image_urls[0]))){
                    echo '<img src="'.$product['image1'].'" width="200" height ="200" class="me-3 mb-3" style="border: 1px solid; padding: 10px;">';
                }
                ?>
                ...
                <?php if (isset($image_urls[0])): ?>
                    <img src="<?php echo $image_urls[0] ?>" width="200" height ="200" class="me-3" style="border: 1px solid; padding: 10px;">
                <?php endif ?>
            ...
            <!-- ảnh 2 -->
                ...
                <?php
                    if(isset($product['image2'])&& (!isset($image_urls[1]))){
                        echo '<img src="'.$product['image2'].'" width="200" height ="200" class="me-3 mb-3" style="border: 1px solid; padding: 10px;">';
                    }
                ?>
                ...
                <?php if (isset($image_urls[1])): ?>
                    <img src="<?php echo $image_urls[1] ?>" width="200" height="200" class="me-3" style="border: 1px solid; padding: 10px;">
                <?php endif ?>
                ...
                <?php
                    if(isset($product['image3'])&& (!isset($image_urls[2]))){
                        echo '<img src="'.$product['image3'].'" width="200" height ="200" class="me-3 mb-3" style="border: 1px solid; padding: 10px;">';
                    }
                ?>
                ...
                <?php if (isset($image_urls[2])): ?>
                    <img src="<?php echo $image_urls[2] ?>" width="200" height="200" class="me-3" style="border: 1px solid; padding: 10px;">
                <?php endif ?>
            </div>
    ...
    <div class="col-md-12 d-flex justify-content-center">
        <div class="col-md-11">
            <hr>
            <form method="POST" action="updateProductProcess" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="basic-info col-md-12 mt-3" styple="font-size:20px">
                    ...
                    <div class="input-group mb-3 mt-5">
                        ...
                        <div class="col-md-12 pe-4">
                            <div class="input-group mb-3">
                                <span class="pe-3" dir="rtl" style="min-width: 161px;"> Danh mục sản phẩm</span>
                                <input readonly name="prodCategoryUpdate" class="" value ="<?php echo $product['name'] ?>" required style="max-width: 500px;border: 1px solid #ced4da;padding:8px">
                                </input> 
                            </div>
                        </div>
                        <div class="col-md-12 pe-4">
                            <div class="input-group mb-3">
                                <span class="pe-3" dir="rtl" style="min-width: 161px;"> Chọn nhà cung cấp</span>
                                <input name="prodSupplierUpdate" class="" value="<?php echo $product['supplierName'] ?>" required style="max-width: 500px;border: 1px solid #ced4da;padding:8px" readonly></input>
                            </div> 
                        </div>
                ...
                <div class="col-md-12 py-2 d-flex justify-content-end">
                    <a type="button" href="products" class="btn btn-secondary px-4">Hủy và quay lại</a>
