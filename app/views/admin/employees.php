...
<div class="col-md-12 mt-2 mb-3 nav-page">
    <h5 class="text-muted"><a href="./index">Trang quản trị hệ thống</a> / </span><a href="">Quản lý nhân viên</a></h5>
</div>
<!--  -->
...
<div class="col-md-12 manage-products shadow">
    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-between">
            ...
            <a type="button"  href="./addEmployee" class="btn btn-primary ms-auto">
                <i class="bi bi-plus-circle-fill me-1"></i>Thêm
            </a>
            <a type="button"  href="./deleteAllEmployee" onclick="return confirm('Bạn có chắc chắn muốn xóa toàn bộ nhân viên? ')" class="btn btn-danger ms-3">
        ...
        <table class="styled-table">
            ...
            <tbody id="table-products">
                ...
                echo '<tr>';
                    ...
                    //Sửa thông tin NCC
                    echo "<th>";
                    echo '<a onclick="return confirm(\'Bạn muốn sửa thông tin nhân viên ' . $employee['fullname'] . ' ?\')" type="button" class="btn text-warning " href="updateEmployee?id=' . $employee['employeeID'] . '">';
                    ...
                    echo '</th>';
                     ...
                     //Xóa NCC
                    echo "<th>";
                    echo '<a onclick="return confirm(\'Bạn có chắc chắn muốn xóa nhân viên ' . $employee['fullname'] . ' ?\')" type="button" class="btn ms-auto text-warning" href="deleteEmployee?id=' . $employee['employeeID'] . '">';
