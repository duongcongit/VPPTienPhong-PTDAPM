...
<div class="col-md-12 mt-2 mb-3 nav-page">
    <h5 class="text-muted"><a href="./index">Trang quản trị hệ thống</a> / </span><a href="">Quản lý tài khoản người dùng</a></h5>
</div>
        ...
        <table class="styled-table">
            ...
            <tbody id="table-products">
                ...
                echo '<tr>';
                    ...
                    echo '</th>';
                    if($user['status']==0){
                        echo '<th><i class="bi bi-exclamation-triangle text-warning ms-3" style="font-size:24px"></i></th>';
                    }
...
<div id="confirmation-dialog">
    <div id="confirmation-dialog-content">
        ...
        <div>
            <input type="radio" id="choice0" name="choice" value="0">
            <label for="choice0">Tài khoản đang chờ xác nhận</label>
        </div>
        <div>
            <input type="radio" id="choice1" name="choice" value="1">
            <label for="choice1">Tài khoản hoạt động bình thường</label>
        </div>
        <div>
            <input type="radio" id="choice2" name="choice" value="2">
            <label for="choice2">Tài khoản bị khóa </label>
        </div>
...
<script>
    ...
    function confirmAction() {
        ...
        var id = elementId;
        if (choice) {
            window.location.href = "changeStatusCustomer?id="+ id + "&choice=" + choice.value;
            hideConfirmation();
        } else {
